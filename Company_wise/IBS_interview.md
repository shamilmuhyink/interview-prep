...
### Q22: How do you find the maximum and minimum numbers in a list using Java 8 Streams?
**Answer:**
```java
...
### Q23: How do you count the occurrences of each character in a String using Streams?
**Answer:**
```java
...
### Q24: How do you count the occurrences of each word in a String using Streams?
**Answer:**
```java
...
### Q25: How do you find duplicate elements in a List using Streams?
**Answer:**
```java
...
### Q26: How do you group a list of objects (e.g. Employees) by a property (e.g. Department) using Streams?
**Answer:**
```java
...
### Q27: How do you find the employee with the highest salary using Streams?
**Answer:**
```java
...
### Q28: How do you sort a list of employees by age and then by salary using Streams?
**Answer:**
```java
...
### Q29: Write a program to print a pyramid pattern of stars.
**Answer:**
```java
...
### Q30: Write a program to swap two numbers without using a third/temporary variable.
**Answer:**
```java
...
### Q31: How do you remove duplicate elements from an Array?
**Answer:**
...
### Q32: Write a logic to check if a String is a Palindrome.
**Answer:**
```java
...
### Q33: How do you find the second highest number in an array?
**Answer:**
```java
...
### Q35: Write a program to reverse a String without using built-in methods.
**Answer:**
```java
...
### Q36: Find the first non-repeating character in a String.
**Answer:**
...
### Q37: How to find if a Linked List has a cycle?
**Answer:**
...
### Q38: How do you rotate a square matrix by 90 degrees in-place?
**Answer:**
...
### Q39: How do you print a 2D matrix in a spiral order?
**Answer:**
...
### Q40: How do you change the default port of a Spring Boot application?
**Answer:**
...
### Q41: How do you read custom properties from application.properties or YAML in Spring Boot?
**Answer:**
...
### Q42: What are the mechanisms to call a 3rd party REST API in Spring Boot?
**Answer:**
...
### Q43: What is the difference between `@RequestParam` and `@PathVariable` in Spring?
**Answer:**
...
### Q44: How do you implement Global Exception Handling in a Spring Boot application?
**Answer:**
...
### Q45: Differentiate between Hibernate `Session` and `SessionFactory`.
**Answer:**
...
### Q46: What is Dependency Injection (DI) and Inversion of Control (IoC)?
**Answer:**
...
### Q47: Explain the different Bean Scopes in Spring.
**Answer:**
...
### Q49: How does Spring Boot Auto-configuration work?
**Answer:**
...
### Q50: What is the purpose of Spring Boot Actuator?
**Answer:**
...
### Q51: Difference between `@Component`, `@Service`, `@Repository`, and `@Controller`.
**Answer:**
...
### Q52: How do you secure a REST API using Spring Security and JWT?
**Answer:**
...
### Q54: What is `@Transactional` propagation?
**Answer:**
...
### Q55: Explain the exact flow of JWT Authentication in Spring Security.
**Answer:**
...
### Q56: Explain Component Lifecycle Hooks in Angular.
**Answer:**
...
### Q57: How do you handle form validation in Angular and Spring Boot?
**Answer:**
...
### Q58: What is the difference between Directives and Components in Angular?
**Answer:**
...
### Q59: Explain the difference between Observables and Promises.
**Answer:**
...
### Q60: What is RxJS? Name a few commonly used RxJS operators.
**Answer:**
...
### Q61: How does Routing work in Angular? Explain Route Guards.
**Answer:**
...
### Q62: What are Angular Interceptors?
**Answer:**
...
### Q63: Explain Agile Methodology and its standard ceremonies.
**Answer:**
...
### Q64: How do you build a runnable JAR file using Maven?
**Answer:**
...
### Q65: What is the difference between `git merge` and `git rebase`?
**Answer:**
...
### Q66: What is the API Gateway pattern?
**Answer:**
...
### Q67: How do you implement an API Gateway in Spring Cloud and handle routing?
**Answer:**
...
### Q68: Explain the Circuit Breaker pattern.
**Answer:**
...
### Q69: What is Service Discovery? How does Eureka work?
**Answer:**
...
### Q70: How do you handle distributed transactions in Microservices?
**Answer:**
...
### Q71: What is the difference between Kafka and RabbitMQ?
**Answer:**
...
### Q72: What is Docker? How do you containerize a Spring Boot app?
**Answer:**
...
### Q74: What is the purpose of Database Indexing?
**Answer:**
...
### Q75: Write a SQL query using JOIN, GROUP BY, and HAVING to find departments with more than 5 employees.
**Answer:**
```sql
